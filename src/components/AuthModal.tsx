    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-[1000] flex items-center justify-center p-4">
        ...
        >
          ...
          <div className="p-6">
            <h3 className="text-2xl font-semibold mb-6 text-[#17294F]">Welcome to Khubo</h3>
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
               ...
               <button 
                 type="submit"
                 disabled={isLoading}
                 className="w-full bg-[#17294F] text-white py-3.5 rounded-xl font-bold uppercase tracking-widest mt-2 hover:bg-[#1e3466] disabled:opacity-50 disabled:cursor-not-allowed transition-colors shadow-md"
               >
